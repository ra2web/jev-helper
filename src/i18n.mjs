export const messages = {
 ...
 openDashboard:['数据面板 ↗','Data panel ↗'],dashboardTitle:['对局数据面板','Match data panel'],dashboardIntro:['浏览器本机保存的所有托管对局：战绩、元信息、曲线和每一次决策。最多保留 100 场；可逐场或全部导出为 JSON。','Every autopilot match kept in this browser: results, metadata, curves and each decision. Up to 100 matches are kept; export one or all as JSON.'],
 exportAll:['导出全部数据','Export everything'],clearAll:['清空全部战绩','Clear all matches'],deleteMatch:['删除这场','Delete this match'],exportWithLog:['导出这场（含日志）','Export this match with its log'],
 matchLabel:['标签','Label'],matchNotes:['备注','Notes'],saveMeta:['保存标签与备注','Save label and notes'],metaSaved:['已保存。','Saved.'],matchDeleted:['已删除。','Deleted.'],allExported:['已导出 {n} 场。','Exported {n} matches.'],confirmClearAll:['确定清空全部战绩和日志？此操作不可恢复。','Clear all matches and logs? This cannot be undone.'],confirmDelete:['确定删除这场战绩和它的日志？','Delete this match and its log?'],
 summaryMatches:['{n} 场','{n} matches'],summaryWins:['胜 {w} · 负 {l} · 未定 {u}','{w} won · {l} lost · {u} undecided'],summaryDecisions:['共 {n} 次决策','{n} decisions in total'],summaryTime:['托管总时长 {t}','{t} under autopilot'],
 colWhen:['时间','When'],colLabel:['标签 / 页面','Label / page'],colSource:['来源','Source'],colOutcome:['结果','Outcome'],colDuration:['时长','Duration'],colDecisions:['回答','Replies'],colCredits:['结束资金','Final credits'],colArmy:['部队峰值','Peak army'],colLosses:['损失 / 击毁','Lost / killed'],
 metaTitle:['对局元信息','Match metadata'],metaPage:['页面','Page'],metaPlayers:['玩家','Players'],metaMap:['地图尺寸','Map size'],metaStart:['开始拍 / 秒','Start tick / seconds'],metaNone:['这场没有记录元信息（0.5.0 之前的版本）。','No metadata was recorded for this match (before 0.5.0).'],metaAi:['AI','AI'],metaHuman:['人类','Human'],metaAlly:['盟友','Ally'],metaEnemy:['敌方','Enemy'],
 timelineTitle:['关键事件','Key events'],decisionsTitle:['决策记录','Decision records'],decisionsHint:['每行一次模型问答：各决策组的选择与置信度。只显示前 {n} 条，完整内容在导出文件里。','One model exchange per row: each group\'s choice and confidence. Showing the first {n}; the export holds everything.'],colTick:['拍','Tick'],colChoices:['选择','Choices'],colLatency:['耗时','Latency'],
 logSection:['全局决策日志','Global decision log'],logSectionHint:['最近约 2000 条跨对局的记录，用于快速排查；单场完整日志在各场详情里。','The last ~2,000 entries across matches, for quick checks; each match keeps its own full log in its detail view.'],
 ...
 imported:['已读取 Jev 配置，请检查 API 地址并保存。','Configuration imported. Review the API URL and save.'],saveFirst:['请先保存修改后的设置。','Save your changes first.'],testing:['正在测试 {name} 连接…','Testing the {name} connection…'],tested:['{name} 连接成功 · {ms} ms{model}。可进入对局开启托管。','Connected to {name} · {ms} ms{model}. Enter a match to start autopilot.'],hotkeyChanged:['快捷键已修改，保存后在游戏页面生效。','Shortcut changed. Save to apply it in the game.'],saved:['设置已保存。回到游戏页面即可一键托管。','Settings saved. Return to the game to start autopilot.'],savedUnauthorized:['设置已保存，但还没有授权访问 {origin}。点「授权访问」即可，无需重新填写。','Settings saved, but access to {origin} is not authorized yet. Click “Authorize access”; nothing needs to be re-entered.'],permissionNeeded:['需要授权访问 {origin} 才能开启托管或测试连接。','Access to {origin} must be authorized before autopilot or a connection test.'],authorize:['授权访问','Authorize access'],authorized:['已授权访问 {origin}。','Access to {origin} authorized.'],keyCleared:['已清除保存的密钥。','Saved key cleared.'],connectionFailed:['连接失败','Connection failed'],toastOn:['{name} 托管已开启','{name} autopilot started'],toastOff:['{name} 托管已停止','{name} autopilot stopped'],
...
const errors = {
 ...
 '尚未授权访问模型服务地址，请在插件中点击「授权访问」。':'Access to the model service has not been authorized. Click “Authorize access” in the extension.',
 ...
 'API 地址须以 http:// 或 https:// 开头。':'The API URL must start with http:// or https://.',
